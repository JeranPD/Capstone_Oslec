...
const reducer = (state, action) => {
  ...
  if (action.type === GET_PENDING_BEGIN) {
    return {
      ...state,
      isLoading: true,
      showAlert: false
  ...
  if (action.type === CHANGE_PAGE_PENDING) {
    return { ...state, pendingPage: action.payload.pendingPage };
  }
  ...
  if (action.type === GET_LISTBRAND_BEGIN) {
    return { ...state, isLoading: true, showAlert: false };
  }
  if (action.type === GET_LISTBRAND_SUCCESS) {
    return {
      ...state,
      isLoading: false,
      listOfBrand: action.payload.listOfBrand,
      listOfPart: action.payload.listOfPart,
